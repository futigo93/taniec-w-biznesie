...
<ArticleSection label="3. Pułapka wyceny: jak kartowiec zaczyna dyktować Twój cennik">
  ...
  Brzmi to jak drobna korekta cennika. W praktyce to jedno z niewielu miejsc, w których naprawdę można zacząć odzyskiwać kontrolę - i o tym właśnie jest następna część.
</ArticleSection>

<ArticleSection label="4. Wyjście: jak przestać wyceniać się pod tolerancję kartowca">
  Pierwszy instynkt, kiedy klient z karty stanowi już większość Twojej sali, jest zrozumiały: dostosować się do jego oczekiwań. W końcu to on teraz napędza frekwencję. Ten instynkt prowadzi jednak tylko w jedną stronę - do jeszcze większego udziału kart w Twoim biznesie.

  Ubieraj się do pracy, którą chciałbyś mieć, nie do tej, którą masz teraz. Innymi słowy: buduj cennik i zasady pod szkołę, jaką chcesz prowadzić za dwa lata, nie pod klienta, który akurat dziś stanowi większość.

  Nie chodzi o to, żeby wywrócić stolik. Chodzi o to, żeby zacząć kreować zasady we własnej szkole, zamiast czekać, aż ułożą je za Ciebie rynek i przyzwyczajenia kartowców.

  Weź na przykład dopłatę za drugą godzinę. Nieuleganie presji multisportowców nie musi oznaczać twardego weta - postawisz się i stracisz ich wszystkich, a nie o to przecież chodzi. Ale skoro Twoi kursanci z karnetem płacą z góry za cały miesiąc, możesz tego samego oczekiwać od posiadacza karty. Zamiast 20 zł dopłaty przy każdym wejściu na drugą godzinę, zaproponuj miesięczny "karnet dopłat" - powiedzmy 80 zł za cały miesiąc. Arytmetycznie to podobna kwota, ale psychologicznie coś zupełnie innego: każdy taki krok w stronę regularności zmniejsza później opór przed całkowitym porzuceniem karty na rzecz zwykłego karnetu, zwłaszcza jeśli przywilejów karty zostaje w Twojej szkole coraz mniej.

  I jeszcze jedno - nie nazywaj tego dopłatą. Klient nie powinien czuć, że musi "dopłacać" z decyzji szkoły "wyciągającej każdy grosz". Postaw sprawę jasno: emitent karty pokrywa jedną godzinę zajęć, drugą trzeba kupić z cennika, tak jak każdy inny kursant. Cennik, który obowiązuje wszystkich: cztery godziny miesięcznie, 100 zł. **To nie dopłata. To po prostu wejściówka z cennika.**
...
<ArticleSection label="5. Dlaczego: dylemat więźnia sprawia, że bunt pojedynczej szkoły nie działa">
...
<ArticleSection label="6. Rozwiązanie: cicha ewolucja i zarządzanie tarciem zamiast rewolucji">
...
<ArticleSection label="7. Negocjacje: cztery filary, które dają Ci pozycję przy stole">
...
<ArticleSection label="8. Dywersyfikacja: druga noga biznesu, której karta nigdy nie dotknie">
  ...
  Zostaje jeszcze jedno pytanie - czy karty w ogóle muszą być przeciwnikiem w tej historii.
</ArticleSection>

<ArticleSection label="9. Apel: karty nie są wrogiem, bierność jest">
  Większość właścicieli, z którymi rozmawiam o kartach, zaczyna działać w tym samym momencie: gdy operator przejął już dużą część ich decyzyjności ekonomicznej. Dopiero wtedy przychodzi frustracja, dopiero wtedy zaczyna się walka. To nie jest sytuacja całkowicie przegrana, ale jest już późno.

  Mój apel jest prosty: zacznij wcześniej. Wprowadzaj bezpieczniki, dobre praktyki, analizuj strukturę przychodów. Nie pozwól sobie przespać momentu, w którym jeszcze można coś zmienić.

  Oligopol kart sportowych nie robi nic zaskakującego, wykorzystując bierność. Robi dokładnie to, do czego został zbudowany - maksymalizuje swój zysk. Trudno mieć o to pretensje do samych operatorów. Jeśli lecisz na bierności, jeśli sam nie kreujesz sytuacji wokół siebie, jeśli wybierasz najniższą linię oporu, kończysz tak jak większość: w przegranym dla wszystkich szkół dylemacie więźnia.

  Ale jeśli przygotujesz dla kart zdrowe, ograniczone miejsce w swojej szkole, jeśli będziesz się dywersyfikować i stać na wielu nogach, okazuje się, że karta może być czymś więcej niż przeciwnikiem. Może być realnym partnerem - do negocjacji, do wspólnego wzrostu, do wspólnego zdobywania kursantów. Skoro kursant może przyjść na zajęcia, a rachunek ureguluje za niego ktoś inny, to dlaczego nie? Trzeba tylko o to zadbać świadomie, a nie zostawić sprawę, żeby "jakoś się ułożyła".

  Morderczy instynkt wobec kart da się więc przekuć w coś dużo bardziej użytecznego: w kontrolowany udział jednej z Twoich nóg biznesowych.
</ArticleSection>

<ArticleSection label="10. Zakończenie">
  <Callout title="Kilka rzeczy, które warto zapamiętać">
    ...
    * **Nazwa robi różnicę** - "dopłata" brzmi jak ustępstwo, cennikowa "wejściówka na drugą godzinę" brzmi jak normalna oferta. To ta sama kwota, ale nie ta sama psychologia.
    * **Bunt pojedynczej szkoły prawie nigdy nie działa** - rynek jest rozproszony, a każda szkoła osobno ma silniejszy bodziec do współpracy niż do oporu przeciw emitentowi.
    * **Zarządzanie tarciem, nie zakazy** - fast-track dla własnych kursantów kosztuje niewiele, a realnie przesuwa wybór klienta.
    * **Karty mogą być zdrową nogą biznesu, nie tylko zagrożeniem** - ale tylko wtedy, gdy sam świadomie ograniczasz ich miejsce, zamiast czekać, aż samo się ułoży.
  </Callout>
  ...
  A jeśli chcesz wspólnie pochylić się nad rozwiązaniami, zapraszam:

  [kontakt@taniecwbiznesie.pl](Mailto:kontakt@taniecwbiznesie.pl)
  [baileo@baileo.pl](mailto:baileo@baileo.pl)
  Jakub Nowak
