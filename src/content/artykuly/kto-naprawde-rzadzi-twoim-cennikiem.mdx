...
<ArticleSection label="4. Wyjście: jak przestać wyceniać się pod tolerancję kartowca">
  Pierwszy instynkt, kiedy klient z karty stanowi już większość Twojej sali, jest zrozumiały: dostosować się do jego oczekiwań. W końcu to on teraz napędza frekwencję. Ten instynkt prowadzi jednak tylko w jedną stronę - do jeszcze większego udziału kart w Twoim biznesie. Im łatwiej się z kartowcem obchodzisz, tym mocniej się w Twojej szkole zadomawia.
...
<ArticleSection label="9. Apel: karty nie są wrogiem, bierność jest">
  ...
  Mój apel jest prosty: zacznij wcześniej. Wprowadzaj bezpieczniki, dobre praktyki, analizuj strukturę przychodów, zanim zrobi to za Ciebie frustracja. Nie pozwól sobie przespać momentu, w którym jeszcze łatwo coś zmienić.

  Oligopol kart sportowych nie robi nic złego, wykorzystując bierność - robi dokładnie to, do czego został zbudowany. Trudno mieć o to pretensje do samych operatorów. Jeśli lecisz na bierności, jeśli sam nie kreujesz sytuacji wokół siebie, jeśli wybierasz najniższą linię oporu, kończysz tak jak większość: w przegranym dla obu stron dylemacie więźnia, o którym była mowa wcześniej.

  Ale jeśli przygotujesz dla kart zdrowe, ograniczone miejsce w swojej szkole, jeśli będziesz się dywersyfikować i stać na wielu nogach, okazuje się, że karta może być czymś więcej niż przeciwnikiem. Może być realnym partnerem - do negocjacji, do wspólnego wzrostu, do wspólnego zdobywania kursantów. Skoro kursant może przyjść na zajęcia, a rachunek ureguluje za niego ktoś inny, to dlaczego nie? Trzeba tylko o to zadbać świadomie, a nie zostawić sprawie, żeby "jakoś się ułożyła".
