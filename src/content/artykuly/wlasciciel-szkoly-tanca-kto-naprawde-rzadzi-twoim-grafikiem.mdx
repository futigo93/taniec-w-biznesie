...
topic: strategia
cover: >-
  /artykuly/okladki/wlasciciel-szkoly-tanca-kto-naprawde-rzadzi-twoim-grafikiem/cover.png
date: 2026-09-05
featured: false
author: {}
audio: {}
...
<ArticleSection label="3. Pułapka wyceny: jak kartowiec zaczyna dyktować Twój cennik">
  ...
  Wysoki procent obecności z kart nie musi jednak znaczyć równie wysokiego procentu przychodu. Część kart limituje liczbę odbić w ciągu dnia - jedno dziennie, albo jedno na dwie godziny, tak zwany <MarginNote term="multiklik" title="Co to jest multiklik?" note="Zapis w umowie z operatorem karty określający, ile razy dziennie kursant może odbić kartę bez dodatkowej opłaty. Bez multiklika druga godzina zajęć tego samego dnia nie jest już objęta kartą - trzeba ją kupić osobno z oferty szkoły." />. Druga godzina zajęć tego samego dnia nie jest już objęta kartą - trzeba ją kupić osobno.
