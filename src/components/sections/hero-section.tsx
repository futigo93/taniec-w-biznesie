...
const heroSignals = [
  ...
  "konkretne treści, które pomagają działać spokojniej",
];
...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="relative grid gap-6 px-5 py-8 md:gap-10 md:px-10 md:py-14 lg:grid-cols-[minmax(0,1.4fr)_minmax(280px,0.8fr)] lg:items-end">
        <div className="space-y-6">
          <div className="space-y-3">
            <p className="eyebrow-accent tracking-[0.38em]">Taniec w Biznesie</p>
            <h1 className="heading-display text-heading max-w-4xl text-[1.78rem] leading-[1.03] md:text-6xl">
            ...
            <p className="text-body max-w-2xl text-base leading-7 md:text-xl md:leading-8">
              Jeśli szkoła rośnie, a Ty coraz częściej gasisz wyjątki i ręcznie tłumaczysz ofertę, znajdziesz tu treści,
              które pomagają to poukładać.
            </p>
          </div>
        ...
        <aside className="accent-hover-lift rounded-[2rem] border border-[color:var(--surface-focus-border)] bg-[var(--surface-focus)] p-5 text-heading md:p-6">
          <div className="flex items-center gap-3 text-sm uppercase tracking-[0.2em] text-primary/80">
            <BookOpenText className="h-4 w-4" />
            Dla kogo jest to miejsce
          </div>
          <h2 className="heading-display-soft text-heading mt-4 text-[2rem] leading-tight md:text-3xl">
            Szkoła potrzebuje dziś nie tylko pasji, ale też lepszych decyzji.
          </h2>
          <p className="text-body mt-4 text-sm leading-6">
            To miejsce jest dla osób, które czują, że prowadzenie szkoły coraz bardziej zależy od jakości decyzji,
            komunikacji i codziennego porządkowania chaosu.
          </p>
