    ...
    >
      ...
      <div className="relative mx-auto flex max-w-4xl flex-col gap-6 px-6 py-16 text-white sm:px-10 md:py-24">
        ...
        <h1 className="text-3xl font-semibold leading-tight md:text-5xl">
          Taniec w biznesie to przestrzeń dla właścicieli szkół tańca – zdobywaj wiedzę,
          chłoń doświadczenie, dziel się motywacją.
        </h1>
        <p className="text-lg text-white/85">
          Zapisz się do społeczności osób zainteresowanych poszerzaniem kompetencji w
          rozwijaniu szkół tańca. Jako pierwszy prezent dostaniesz ebook „Czego nie wiesz o
          prowadzeniu szkoły tańca”. To nic nie kosztuje.
        </p>
        <div>
