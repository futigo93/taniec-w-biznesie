...
export function CallToActionSection() {
  return (
    <section
      id="zapis"
      className="surface-signal scroll-mt-32 rounded-[2.5rem] p-6 text-heading md:p-10"
    >
      <div className="grid gap-8 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-start">
        <SectionHeading
          ...
          titleClassName="heading-display text-4xl leading-tight md:text-5xl"
          descriptionClassName="text-body"
          className="[&_p]:leading-8 [&_p]:text-body"
        />
