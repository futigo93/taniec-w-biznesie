    ...
    <div className="page-wash py-12">
      <article className="mx-auto max-w-3xl space-y-6 px-4 md:px-0">
        <ArticleHero
          ...
          path="/artykuly/instruktor-tanca-twardy-zad-swiezaka"
          imageSrc="/artykuly/okladki/instruktor-tanca-twardy-zad.webp"
          imageAlt="Instruktor tańca - twardy zad świeżaka"
          authorName="Jakub Nowak"
          date="19 stycznia 2026"
        />

        <h2 className="pt-4 text-2xl font-semibold text-foreground">Energia</h2>
        <p className="text-base leading-8 text-foreground/85">Spróbuj przejść ze mną przez mały eksperyment. Wyobraź sobie, że właśnie zostałeś instruktorem tańca.</p>
        <p className="text-base leading-8 text-foreground/85">Bycie młodym, świeżym instruktorem jest niepowtarzalnym doświadczeniem. Jeszcze wczoraj byłeś kursantem albo tancerzem. Dziś świat daje Ci coś więcej: możliwość zarabiania na pasji, bycia po drugiej stronie sali, mówienia do ludzi, bycia słuchanym, podziwianym. Pojawia się poczucie sensu, sprawczości, znaczenia. Masz wrażenie, że wszystko wreszcie układa się w jedną historię.
        ...
        <p className="text-base leading-8 text-foreground/85">Na drugie zajęcia przychodzi połowa.</p>
        <p className="text-base leading-8 text-foreground/85">Po trzecich zajęć już nie ma. Kurs zostaje zamknięty. Ktoś decyduje, że to się nie spina. Wracasz do domu i przez kilka dni nie bardzo wiesz, co ze sobą zrobić. Emocjonalnie to jest dużo. Zderzenie z rzeczywistością przychodzi szybko i bez ostrzeżenia.
        ...
        <p className="text-base leading-8 text-foreground/85">Młody instruktor ma jedną rzecz, której później już nigdy nie będzie miał w takiej ilości: energię. Świeżą, intensywną, bezwarunkową. Gotowość do poświęcenia wszystkiego. Większość osób na starcie nie cierpi na brak motywacji. Cierpi na jej nadmiar. I właśnie dlatego tak łatwo ją zmarnować.
        ...
        <p className="text-base leading-8 text-foreground/85">Problem polega na tym, że rynek nie daje przestrzeni na długie uczenie się „na żywo”. Zwłaszcza w dużych miastach. Konkurencja jest ogromna. Kursanci mają wybór. Szkoły nie mogą sobie pozwolić na eksperymenty. Jeśli jesteś związany z dużą szkołą, nikt nie odda Ci grupy tylko po to, żebyś się uczył. Ryzyko jest zbyt duże. Dlatego bardzo wiele osób odpada na samym początku - nie dlatego, że nie mają talentu czy predyspozycji by zostać świetnym instruktorem. Ale dlatego, że nie mieli gdzie bezpiecznie popełniać błędów.</p>
        <p className="text-base leading-8 text-foreground/85">Ja zaczynałem w małym mieście. To było ogromne ułatwienie. Konkurencja była niewielka, rynek bardziej wyrozumiały. Mogłem popełniać błędy i uczyć się na nich. Spaliłem kilka pierwszych grup, zanim zacząłem rozumieć, co właściwie robię źle. Nie każdy będzie miał taki komfort. W Warszawie być może nigdy nie dostałbym szansy zacząć w taki sposób.
        ...
        <p className="text-base leading-8 text-foreground/85">Dla początkującego instruktora to szczególnie niebezpieczne. Pracy jest tak dużo, że niezależnie od stawki godzinowej realny „zarobek” i tak bywa symboliczny. Dlatego aby to miało jakikolwiek sens, ten okres należy traktować jako inwestycję w naukę zawodu - robić dużo, angażować się, ale nie tylko na sali.</p>
        <h2 className="pt-4 text-2xl font-semibold text-foreground">Iteracja</h2>
        <p className="text-base leading-8 text-foreground/85">Droga do bycia instruktorem jest długa. Znacznie dłuższa, niż sugerują to pierwsze okazje do poprowadzenia zajęć. Nasz rynek rzadko oferuje pozycję „junior instruktora”. Rzadko daje mentora, który będzie czuwał nad procesem, brał na siebie część odpowiedzialności, pozwalał bezpiecznie popełniać błędy. W większości przypadków trzeba nauczyć się tego zawodu samemu, obserwując, próbując, poprawiając się w biegu.
        ...
        <p className="text-base leading-8 text-foreground/85">Trudno szukać dobrego instruktora, który nie przeszedł tej pętli wielokrotnie.
